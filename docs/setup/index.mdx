...
```python
# CODE_BLOCK_1
# prompt: Install Atlas CLI using this link https://fastdl.mongodb.org/mongocli/mongodb-atlas-cli_1.37.0_linux_x86_64.deb
...
**Important!** Click the connect link https://account.mongodb.com/account/connect and input the 8 digit code prompted. 
